...
const NotesManager: React.FC<NotesManagerProps> = ({
  ...
  const submitHandler = async (event: any) => {
    ...
    const res = await axios.post(`/api/admin/subject/${subject.subjectId}`, myForm)
    .then(res => {
          ...
          >
            ...
            <div className='flex flex-row gap-3 w-full justify-end mt-2'>
              ...
              <OutlineButton
                ...
                leftIcon={HiPlus}
              >
                <label htmlFor='notes-pdf' className='cursor-pointer font-medium'> Add Notes </label>
              </OutlineButton>
...
const AdminNotesCard: React.FC<AdminNotesCardProps> = ({
  index, notes, subjectId, deleteNotesHandler
}) => {
  return (
    <div className='
      ...
      <div className='flex flex-row items-start gap-2.5'>
        ...
        <div className='flex flex-col gap-1'>
          <h3 className='text-xl font-semibold'>
            {notes.title} <span className='font-normal'>by</span> {notes.contributor}
          </h3>
