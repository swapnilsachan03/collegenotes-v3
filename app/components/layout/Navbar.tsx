...
const Navbar: React.FC<NavbarProps> = ({ currentUser: user }) => {
  ...
  return (
    <>
      <nav
        className={`flex flex-row items-center justify-between px-4 py-3 border-b-[1px] ${
      ...
      >
        ...
        <div className="flex items-center">
          <div className="hidden flex-row items-center lg:flex">
            ...
            <Link href={"/subjects"} className={styles.navbarLinks}>
              {" Subjects "}
            </Link>
            <Link href={"/blog"} className={styles.navbarLinks}>
              {" Blog "}
            </Link>
            <Link href={"/contribute"} className={styles.navbarLinks}>
              {" Contribute "}
            </Link>
      ...
      <nav
        className={`${navbarDisplay} fixed top-0 left-0 flex flex-col items-center justify-center w-full h-full bg-inherit z-10`}
      >
        <button
