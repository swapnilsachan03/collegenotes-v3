...
const DataCard: React.FC<DataCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm opacity-70">Since last month</p>
    </div>
  );
};
      ...
      >
        ...
        >
          <p className="text-center text-sm mb-6 opacity-50">
            Last change was on {new Date(stats[11].createdAt).toDateString()},{" "}
            {new Date(stats[11].updatedAt).toLocaleTimeString()}
          </p>
          ...
          >
            <DataCard
              title={"Views"}
              quantity={viewsCount}
              quantityPercent={viewsChange}
              profit={viewsProfit}
            />
            <DataCard
              title={"Members"}
              quantity={usersCount}
              quantityPercent={usersChange}
              profit={usersProfit}
            />
          </div>
