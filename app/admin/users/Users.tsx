          ...
          <table className="w-[1200px] mx-5">
            ...
            <tbody>
              {users.map((user: SafeUser) => (
                ...
                >
                  <td className="py-4">
                    {user.accounts[0] ? user.accounts[0].provider : "email"}
                  </td>
...
const RoleRadio: React.FC<RadioProps> = ({ role, label, onClick }) => {
  return (
