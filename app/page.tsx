...
export default function Home() {
  const reviews: Review[] = [
    {
      content:
        "CollegeNotes has been an absolute exam-time life saver for me. I can just simply consume video content on YouTube and read notes from here. This saves me a lot of time and spares me the pain of note taking. I would recommend this to everyone.",
      profileImg:
        "https://images.fineartamerica.com/images-medium-large-5/beautiful-summer-landscape-in-mountains-boon-mee.jpg",
      name: "Anurag Kumar",
    ...
    {
      content:
        "CollegeNotes is a good platform for accessing notes, assignments, PYQs and other study materials. The good thing is that all of this is accessible through a single window and that's what makes is more awesome!",
      profileImg:
        "https://images.fineartamerica.com/images-medium-large-5/beautiful-summer-landscape-in-mountains-boon-mee.jpg",
      name: "Rohit Singh",
      institution: "Chandigarh University",
  ...
  return (
        ...
        >
          <div className="flex flex-col justify-start gap-8">
            ...
            <div className="flex flex-row gap-2">
              ...
              <Link href="/blog">
                <OutlineButton color="teal" label="CollegeBlog" />
              </Link>
            </div>
          </div>
      ...
      "
        >
          ...
          <p className="text-[15px] sm:text-base w-full md:w-2/3">
            ...
            , the newest addition to CollegeNotes!
          </p>
          ...
          <div className="flex flex-col items-center md:flex-row gap-7">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-center text-[15px] md:text-base">
                CollegeNotes is now faster than ever! I have made some
                performance improvements to the website to make it load faster
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-center text-[15px] md:text-base">
                CollegeBlog is the latest addition to the platform. Here, you
                can find articles related to college life, exams, and more. You
                can also contribute to the blog by writing articles.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-center text-[15px] md:text-base">
                The UI of the website has been improved. Better colors, better
                fonts, and better accessibility. The website is now more
    ...
    "
      >
        <div className="flex flex-col justify-start gap-8">
          <h2 className="font-extrabold text-4xl">Features for the future.</h2>

          <ul className="list-disc list-inside flex flex-col gap-3">
            <li>
              Users will be able to rate notes and they'll be sorted accordingly
              for better accessibility to the readers.
            </li>
            <li>
