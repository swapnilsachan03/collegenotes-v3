...
export const metadata = {
  ...
  description:
    "Discover a wide range of academic subjects on CollegeNotes Subject Browser. Effortlessly search for study materials, notes, and resources by using keywords, degree, and year filters.",
  keywords:
    "collegenotes, browse subjects, engineering subjects, engineering notes, toppers notes",
  robots: "index, follow",
