...
export const metadata = {
  ...
  description: "These Terms & Conditons reflect the way CollegeNotes' website works, the laws that apply. As a result, these Terms of Service help define CollegeNotes' relationship with you as you interact with our services.",
...
const TermsAndConditions = () => {
  return (
    ...
    '>
      ...
      <p className="mt-4 text-justify">
        These terms and conditions outline the rules and regulations for the use of CollegeNotes's Website, located at <Link href={"/"} className='text-teal-500 hover:underline'>https://www.collegenotes.co.in</Link>.
      </p>
