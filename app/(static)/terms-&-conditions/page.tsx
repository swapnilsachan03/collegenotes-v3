...
export const metadata = {
  title: "Terms & Conditions - CollegeNotes",
  description:
    "These Terms & Conditons reflect the way CollegeNotes' website works, the laws that apply. As a result, these Terms of Service help define CollegeNotes' relationship with you as you interact with our services.",
  keywords: "collegenotes, terms & conditions, t&c collegenotes",
  robots: "index, follow",
...
const TermsAndConditions = () => {
  return (
    ...
    "
    >
      <h1 className="w-full text-center text-4xl lg:text-5xl font-bold mb-4 md:mb-8">
        Terms & Conditions
      </h1>

      <p className="mt-4 text-justify">Welcome to CollegeNotes!</p>

      <p className="mt-4 text-justify">
        These terms and conditions outline the rules and regulations for the use
        of CollegeNotes's Website, located at{" "}
        <Link href={"/"} className="text-teal-500 hover:underline">
          https://www.collegenotes.co.in
        </Link>
        .
      </p>
      ...
      <p className="mt-4 text-justify">
        ...
        conditions. Do not continue to use CollegeNotes if you do not agree to
      ...
      <p className="mt-4 text-justify">
        We employ the use of cookies. By accessing CollegeNotes, you agreed to
        use cookies in agreement with the CollegeNotes's Privacy Policy.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-10">License</h2>

      <p className="mt-4 text-justify">
        Unless otherwise stated, CollegeNotes and/or its licensors own the
        intellectual property rights for all material on CollegeNotes. All
        intellectual property rights are reserved. You may access this from
        CollegeNotes for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className="mt-4 text-justify">You must not:</p>

      <ul className="list-disc list-inside mt-4">
        <li>Republish material from CollegeNotes</li>

        <li>Sell, rent or sub-license material from CollegeNotes</li>

        <li>Reproduce, duplicate or copy material from CollegeNotes</li>

        <li>Redistribute content from CollegeNotes</li>
      </ul>

      <p className="mt-4 text-justify">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        CollegeNotes does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of CollegeNotes,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, CollegeNotes shall not be
      ...
      <p className="mt-4 text-justify">
        CollegeNotes reserves the right to monitor all Comments and to remove
        any Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="mt-4 text-justify">You warrant and represent that:</p>
      ...
      <p className="mt-4 text-justify">
        You hereby grant CollegeNotes a non-exclusive license to use, reproduce,
      ...
      <p className="mt-4 text-justify">
        ...
        the hyperlink compensates the absence of CollegeNotes; and (d) the link
      ...
      <p className="mt-4 text-justify">
        ...
        e-mail to CollegeNotes. Please include your name, your organization
      ...
      <p className="mt-4 text-justify">
        No use of CollegeNotes's logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </p>

      <h2 className="text-2xl font-semibold mt-10">iFrames</h2>
      ...
      <h2 className="text-2xl font-semibold mt-10">Content Liability</h2>
      ...
      <h2 className="text-2xl font-semibold mt-10">Reservation of Rights</h2>
