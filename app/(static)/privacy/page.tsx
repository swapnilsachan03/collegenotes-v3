...
export const metadata = {
  title: 'Privacy Policy - CollegeNotes',
  ...
  keywords: 'collegenotes, privacy policy, collegenotes privacy',
  robots: 'index, follow',

  openGraph: {
    title: 'Privacy Policy - CollegeNotes',
    description: "This Privacy Policy describes the information that we gather on or through our Services and how we use and process such information.",
    url: 'https://www.collegenotes.co.in/privacy',
  },
  ...
  return (
    ...
    '>
      ...
      <p className="mt-4 text-justify">
        At CollegeNotes, accessible from <Link className='text-teal-500 hover:underline' href="/">https://www.collegenotes.co.in</Link>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by CollegeNotes and how we use it.
      </p>
