...
export const metadata = {
  ...
  description:
    "Read the latest & most helpful blogs from the people at CollegeNotes. We write about college life, study tips, course guides, career advice & more. Gain exclusive insights on various topics helpful for your college journey.",
  keywords:
    "collegenotes, collegenotes blog, collegeblog, college advice, assignment solutions",
  robots: "index, follow",
      ...
      >
        <div className="w-full flex flex-col md:flex-row gap-7 items-center">
          ...
          <div className="flex flex-col gap-4 w-full md:w-[50%]">
            ...
            <p className="text-[15px] font-light mt-2">{blogs[0].summary}</p>

            <p className="text-[12px] font-light">
              By <span className="font-semibold"> {blogs[0].authorName} </span>{" "}
              | {createdAt}
            </p>
          </div>
        </div>
