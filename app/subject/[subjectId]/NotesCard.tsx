...
const NotesCard: React.FC<NotesCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <p className='text-[13px] text-justify line-clamp-3 min-h-[59px]'> {notes.description} </p>

      <p className='text-xs font-light text-neutral-600 dark:text-neutral-400'> {notes.institution} </p>
